...
class CAR(Platforms):
  ...
  HONDA_PRELUDE_6G = HondaBoschPlatformConfig(
    ...
    # steerRatio: variable ratio rack, 11.3 is spec end-to-end off-center, 14.9 on-center
    CarSpecs(mass=1480, wheelbase=2.605, steerRatio=15.6, centerToFrontRatio=0.37),
    {Bus.pt: 'honda_bosch_radarless_generated'},
    flags=HondaFlags.BOSCH_RADARLESS,
  )
